...
@implementation NewSceneLayer

+(CCScene *) scene
{
	CCScene *scene = [CCScene node];
	NewSceneLayer *layer = [NewSceneLayer node];
...
-(void)setBackgroundLayer {
  CCLayerColor *backgroundLayerColor = [CCLayerColor layerWithColor:ccc4(125, 125, 190, 255)];
